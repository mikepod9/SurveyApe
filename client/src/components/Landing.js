        ...
        <div className="row">
          <div className="col s12 m4">
            <div className="icon-block">
              ...
              <p className="light">
                ...
                surveys. Each survey costs 1 credit and allows for up to 100,000
                recipients, so you will get the feedback that you need!
              </p>
            </div>
          </div>
          ...
          <div className="col s12 m4">
            <div className="icon-block">
              ...
              <p className="light">
                Your survey recipients will recieve a well styled email that is
                easy to use and understand. Upon submitting feedback, your end
                users will be notified of their successful vote.
              </p>
            </div>
          </div>
          ...
          <div className="col s12 m4">
            <div className="icon-block">
              ...
              <p className="light">
                ...
                Monitor your existing surveys, we provide metrics regarding your
                survey vote count and activity.
              </p>
            </div>
          </div>
        </div>
